...
from SingularCRM.settings import DEFAULT_FROM_EMAIL

from cadastro.forms.empresa import MinhaEmpresaForm
from cadastro.models.empresa import MinhaEmpresa
...
class ForgotPasswordView(FormView):
    template_name = "esqueceu_senha.html"
...
class SelecionarMinhaEmpresaView(FormView):
    ...
    template_name = "selecionar_minha_empresa.html"
